...
function display_menu () {
    ...
    while :
    do
		choice=$(menu_select "Collaboration Apps" "${menu_options[@]}")
		case ${choice} in
		1)  clear
			remove_manifest_app discord
			install_manifest_app discord
			;;
		2)  clear
			remove_manifest_app slack
			install_manifest_app slack
			;;
		3)  clear
			remove_manifest_app zoom
			install_manifest_app zoom
			;;
		4)  clear
			remove_manifest_app discord
			;;
