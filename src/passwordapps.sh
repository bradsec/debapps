...
function display_menu () {
    local menu_options=(
        "Install Bitwarden (Uses an online vault)"
        "Install KeePassXC (Uses an offline vault)"
        "Remove Bitwarden"
        "Remove KeePassXC"
    ...
    while :
    do
        choice=$(menu_select "Password Manager Apps" "${menu_options[@]}")
        case $choice in
        1)  clear
            install_manifest_app bitwarden
            ;;
        2)  clear
            install_manifest_app keepassxc
            ;;
        3)  clear
            remove_manifest_app bitwarden
            ;;
        4)  clear
            remove_manifest_app keepassxc
            ;;
        5)  clear
            validate_manifest_apps bitwarden keepassxc
            ;;
        6)  clear
            exit
            ;;
